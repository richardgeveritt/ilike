                ...
                grain_size = 100000)
{
  ...
  # EnK sequencing.
  enk_sequencer_method = get_enk_sequences(recipe,model_parameter_list)
  ...
  enk_termination_method = get_method(recipe,"enk_termination")
