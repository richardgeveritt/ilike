                                                              ...
                                                              ProposalKernel* proposal)
{
  ...
  {
    arma::colvec current_point = latest_particle.get_transformed_parameters(proposal).get_colvec(variable_name);
  ...
  else
  {
    ...
    arma::colvec current_point = latest_particle.get_transformed_parameters(proposal).get_colvec(variable_name);
    this->estimated.get_mean() = this->estimated.get_mean() + current_gain*(latest_particle.get_transformed_parameters(proposal).get_colvec(variable_name) - this->estimated.get_mean());
