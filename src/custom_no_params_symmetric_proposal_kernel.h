...
{
  /**
   * @file custom_no_params_symmetric_proposal_kernel.h
   * @brief Defines the CustomNoParamsSymmetricProposalKernel class.
   *
   * A custom no params symmetric proposal kernel. Proposes new parameter values during MCMC or SMC moves using a custom no params symmetric distribution centred on the current state.
   *
   * @namespace ilike
   * @class CustomNoParamsSymmetricProposalKernel
   * @brief A custom no params symmetric proposal kernel derived from SymmetricProposalKernel.
   */
...
public:
  ...
  /**
   * @brief Default constructor for CustomNoParamsSymmetricProposalKernel.
   */
  CustomNoParamsSymmetricProposalKernel();
  /**
   * @brief Destructor for CustomNoParamsSymmetricProposalKernel.
   */
  virtual ~CustomNoParamsSymmetricProposalKernel();
  
  /**
   * @brief Constructs a CustomNoParamsSymmetricProposalKernel object.
   *
  ...
  /**
   * @brief Copy constructor for CustomNoParamsSymmetricProposalKernel.
   *
   * @param another The CustomNoParamsSymmetricProposalKernel instance to copy from.
   */
  CustomNoParamsSymmetricProposalKernel(const CustomNoParamsSymmetricProposalKernel &another);
  
  /**
   * @brief Assignment operator for CustomNoParamsSymmetricProposalKernel.
   *
   * @param another The CustomNoParamsSymmetricProposalKernel instance to copy from.
   */
  void operator=(const CustomNoParamsSymmetricProposalKernel &another);
  /**
   * @brief Creates a deep copy of this CustomNoParamsSymmetricProposalKernel object.
   *
   * @return The result.
   */
