                                                                ...
                                                                Particle &particle)
{
  ...
  else
  {
    ...
    info.gradient = this->estimator->get_gradient_of_log(variable,index,particle);
                                                                          ...
                                                                          Particle &particle)
{
  ...
  else
  {
    // if proposal is not found, regenerate all of the variables needed to estimate the gradient
    ReinforceInfo info = ReinforceInfo();
    info.gradient = this->estimator->subsample_get_gradient_of_log(variable,index,particle);
    this->infos[variable] = info;
    return info.gradient;
  }
}
