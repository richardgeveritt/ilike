...
{
  if ( (this->data!=NULL) && (this->proposal_parameters!=NULL) )
  {
  ...
  {
    Rcpp::stop("CustomGuidedProposalKernel::specific_evaluate_kernel - data not specified.");
  }
}
...
void CustomGuidedProposalKernel::set_data(Data* data_in)
{
  this->data = data_in;
}
